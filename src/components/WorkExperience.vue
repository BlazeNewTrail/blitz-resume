		...
		<div class="slds-card__body slds-card__body_inner">
			<div class="slds-progress slds-progress_vertical">
				<ol class="slds-progress__list">
					<li v-for="work in works" :key="work.company" class="slds-progress__item">
						...
						<div class="slds-progress__item_content slds-border_bottom">
							<div class="slds-grid">
								<div class="slds-col slds-size_3-of-4">
									<div class="title">{{ work.position }}</div>
									<div>
									...
									<ol class="slds-list_ordered">
										<li v-for="(point, index) in work.highlights" _:key="index">{{ point }}</li>
									</ol>
								</div>
